...
from simpleutil.log import _options
from simpleutil.log import formatters
from simpleutil.log import handlers
    ...
    def set_filehandler_close_exec():
        ...
        for handler in list(log_root.handlers):
            if isinstance(handler, logging.StreamHandler):
                systemutils.set_cloexec_flag(handler.stream.fileno())
            elif isinstance(handler, logging.handlers.SysLogHandler):
                systemutils.set_cloexec_flag(handler.socket.fileno())
